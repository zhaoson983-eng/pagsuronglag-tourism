...
<div class="hidden lg:block">
    ...
    <div class="bg-white border-b border-gray-200 px-6 py-6">
        <div class="text-center">
            ...
            <p class="text-gray-600 max-w-2xl mx-auto">Discover relaxing resort destinations in Lagonoy</p>
        </div>
    </div>
    ...
    <div class="px-6 py-6">
        ...
        <div id="no-content" class="text-center py-12 hidden">
            ...
            <p class="text-gray-500 text-lg">No resorts available at the moment</p>
            <p class="text-gray-400 text-sm">Check back later for amazing places to relax!</p>
        </div>
    </div>
</div>
...
<div class="lg:hidden">
    ...
    <div class="px-4 py-6 bg-white">
        <div class="grid grid-cols-4 gap-4">
            ...
            <!-- Resorts - Active -->
            <a href="{{ route('customer.resorts') }}" class="flex flex-col items-center p-4 rounded-xl bg-blue-100 border-2 border-blue-300 transition-colors">
                ...
                <span class="text-xs font-medium text-blue-700 text-center leading-tight">Resorts</span>
            </a>
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('Resorts page loaded, starting feed load...');
    loadFeedData();
...
function loadFeedData() {
    ...
    fetch(`/customer/resorts/feed?page=${currentPage}`, {
            headers: {
...
function createFeedItem(item) {
    ...
    const imageSection = item.image ? 
        ...
        `<div class="w-full h-64 bg-gray-200 flex items-center justify-center">
            <i class="fas fa-umbrella-beach text-gray-400 text-4xl"></i>
        </div>`;
                ...
                <div class="flex items-center space-x-3">
                    <div class="w-10 h-10 rounded-full flex items-center justify-center overflow-hidden">
                        ${item.profile_avatar ? 
                            ...
                            `<div class="w-full h-full bg-purple-500 rounded-full flex items-center justify-center">
                    ...
                    <div>
                        ...
                        ${item.min_price ? `<p class="text-sm font-bold text-purple-600">From ₱${parseFloat(item.min_price).toLocaleString()}/night</p>` : ''}
                    </div>
                </div>
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    <button class="flex items-center space-x-1 transition-colors like-btn" 
                            onclick="toggleLike('resort', ${item.id})" 
                    ...
                    <button class="flex items-center space-x-1 transition-colors" onclick="showRating('resort', ${item.id})">
                        <i class="fas fa-star text-yellow-400"></i>
                        <span class="text-sm text-gray-600">${(item.rating || 0).toFixed(1)} (${item.rating_count || 0})</span>
                    </button>
                    <button class="flex items-center space-x-1 text-gray-600 hover:text-blue-600 transition-colors" onclick="showComments('resort', ${item.id})">
